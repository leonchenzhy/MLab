...
class Cluster(object):
    ...
    def averageLinkageDist(self, other):
        ...
        if i > 0:
            ...
            return "No Points in the Cluster!"
...
class ClusterSet(object):
    ...
    def findClosest(self, linkage):
        ...
        bestD = float('inf')
        t = (0,0)
        #t = (self.members[0],self.members[0])
...
def readCityData(fName, scale = False):
    ...
    #print cityNames, featureVectorList
...
def test():
    #points = buildCityPoints('/Users/ZYCHEN/MLab/ClusterCity/exam.txt', True)
    #hCluster(points, Cluster.singleLinkageDist, 5, False)
    points = buildCityPoints('/Users/ZYCHEN/MLab/ClusterCity/exam.txt', False)
    #points = buildCityPoints('/Users/ZYCHEN/Documents/PythonClass/ClusterCities_ML/cityTemps.txt', False)
...
#Smaller Testing Clusters
#points = buildCityPoints('/Users/ZYCHEN/Documents/test.txt', False)
